...
public class EntityUtils {
	public static final String PACKAGE = "com.ourpalm.editor.entity.tables";
	...
	public static void setEditorType(TableTitle dto, Field field, String[] editorOptionsForeign, List<ArrayRule> arrayRules_key) {
		...
		if (field.isAnnotationPresent(Lob.class)) {
			dto.setEditorType(EditorType.Lob);
			return;
		}
		// Array
	...
	public static StringBuffer spellTitle(Class<? extends TableEntity> t, List<Field> declaredFields, Map<Field, Long> arrayFields) {
		// 拼字段名
	...
	public static <T extends TableEntity> StringBuffer spellContent(Class<T> t, List<Field> declaredFields, Map<Field, Long> arrayFields, List<T> data) {
	 ...
	 */
	public static List<TableTitle> getSimpleTitles(Class<? extends TableEntity> entityClass) {
